    ...
    <section class="bg-white dark:bg-gray-800">
      <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
          ...
          <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400 italic">
            They are renewed every morning. Great is your faithfulness.
          </p>
        </div>
        <div class="grid gap-8 lg:grid-cols-2">
          <article
            v-for="blog in renderBlogs"
            :key="blog.id"
          ...
          >
            ...
            <p
              class="mb-5 font-light text-gray-600 dark:text-gray-400 multiline-ellipsis"
            >
              {{ blog.desc }}
            </p>
        ...
        <footer class="bg-gray-50 dark:bg-gray-800">
          <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
            ...
            <div class="text-center">
              ...
              >
                <img class="rounded-full w-8 m-2" src="/logo.png" alt="" />
                JcLahi™
              </a>
              <span
                class="block text-sm text-center text-gray-500 dark:text-gray-400"
                >© 2021-2022 <a href="#" class="hover:underline">JcLahi™</a>.
                All Rights Reserved.
              </span>
